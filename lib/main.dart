...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Receitas',
      theme: ThemeData(
        primarySwatch: Colors.red, // Cor principal do tema
        ...
        textTheme: ThemeData.light().textTheme.copyWith(
              // Definindo um ThemeData com a versão light (que ja passui coisas pré configuradas)
              title: TextStyle(
                // Nesse caso vamos apenas mudar o title do tema "light" mantendo as outras configurações padrão
